...
export interface RepresentativeProduct { title:string;brand:string;productUrl:string;imageUrl:string|null;sourceName:string;sourceType?:"official"|"verified";verificationDate?:string }
...
export const REPRESENTATIVE_PRODUCTS:Record<string,RepresentativeProduct>={
  ...
  faucet_parts:{title:"Bathroom Faucet Parts & Cartridges",brand:"American Standard",productUrl:"https://www.americanstandard-us.com/collections/bathroom-faucet-parts-list",imageUrl:"https://cdn.shopify.com/s/files/1/0609/8567/1727/files/175556_012316-0070A_0_CDNwebp.webp?v=1774636091",sourceName:"American Standard official parts page",sourceType:"official",verificationDate:"2026-08-09"},
  shower_system:{title:"Shower Heads & Hand Showers",brand:"Delta",productUrl:"https://www.deltafaucet.com/bathroom/showering/showerheads-hand-showers",imageUrl:"https://www.deltafaucet.com/dw/image/v2/bfjj_PRD/on/demandware.static/-/Sites-delta-master-catalog/default/dw08ab79a8/images/large/74B430-B1.png",sourceName:"Delta official category page",sourceType:"official",verificationDate:"2026-08-09"},
  backwall:{title:"QWALL-VS Acrylic Shower Wall Kit",brand:"DreamLine",productUrl:"https://dreamline.com/product/dreamline-qwall-vs-28-32-inch-w-x-41-1-2-inch-d-x-76-inch-h-acrylic-wall-kit/shbw-1532760/shbw-1532760-00",imageUrl:null,sourceName:"DreamLine official product page",sourceType:"official",verificationDate:"2026-08-09"},
  drain:{title:"Toe Tapper Drain Assembly",brand:"American Standard",productUrl:"https://www.americanstandard-us.com/products/753980-200-0110a-toe-tapper-drain-assembly",imageUrl:null,sourceName:"American Standard official product page",sourceType:"official",verificationDate:"2026-08-09"},
  valve:{title:"MultiChoice Universal Rough-In Valve",brand:"Delta",productUrl:"https://www.deltafaucet.com/outlet/recertified/bathroom/rough-valves",imageUrl:null,sourceName:"Delta official valves page",sourceType:"official",verificationDate:"2026-08-09"},
};
