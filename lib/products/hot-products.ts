...
const REPRESENTATIVE_PRODUCTS:Record<string,RepresentativeProduct>={
  ...
  faucet_parts:{title:"Bathroom Faucet Parts & Cartridges",brand:"American Standard",productUrl:"https://www.americanstandard-us.com/collections/bathroom-faucet-parts-list",imageUrl:null,sourceName:"American Standard official parts page"},
  shower_system:{title:"Shower Heads & Hand Showers",brand:"Delta",productUrl:"https://www.deltafaucet.com/bathroom/showering/showerheads-hand-showers",imageUrl:null,sourceName:"Delta official category page"},
