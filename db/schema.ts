...
export const buyerWatchlist = sqliteTable(
  "buyer_watchlist",
  {
    ...
    opportunityValueUsd: integer("opportunity_value_usd"),
    opportunityProbability: integer("opportunity_probability"),
    expectedCloseDate: text("expected_close_date"),
    targetMarket: text("target_market"),
    requiredCertifications: text("required_certifications"),
    estimatedAnnualUnits: integer("estimated_annual_units"),
    targetMoq: integer("target_moq"),
    quoteRequirements: text("quote_requirements"),
    createdAt: text("created_at").notNull(),
    updatedAt: text("updated_at").notNull(),
  },
  (table) => [
...
export const leadActions = sqliteTable(
  "lead_actions",
  {
    ...
    qualificationFeedback: text("qualification_feedback"),
