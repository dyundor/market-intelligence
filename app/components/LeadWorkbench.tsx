  ...
  return <div className="lead-workbench" aria-busy={loading||detailLoading}>
    ...
    <div className="lead-layout">
      ...
      {selected?<section className="lead-detail">
        ...
        {actions.some(action=>["no_response","replied","interested","meeting_booked","quote_requested"].includes(action.outcomeCode||""))?<button className="follow-up-draft-action" onClick={()=>generateDraft("follow_up")}>{zh?"根据最近结果生成跟进草稿":"Generate follow-up from latest outcome"}</button>:null}
