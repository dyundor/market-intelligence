...
export async function GET(request:NextRequest){
  ...
  return NextResponse.json({shipment:enrichShipmentRow(shipment as Record<string, unknown>),dataset:"importyeti_free_web",disclaimer:"Displayed date follows the source page date basis; estimated freight is not declared cargo value."});
}
